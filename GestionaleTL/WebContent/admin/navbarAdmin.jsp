		...
		<li>
   		...
   		<li>
    		<form action="MainServlet" id="findlavoro" name="findlavoro" method="post">
    			...
    			<input hidden="hidden" class="labelG" type="text" name="searchlavoro" id="searchlavoro" value ="">
    		</form>
    	</li>
		<li>
        	<form action="MainServlet" id="finddocumentazione" name="finddocumentazione" method="post">
    			...
    			<input hidden="hidden" class="labelG" type="text" name="searchdocumentazione" id="searchdocumentazione" value ="">
    		</form>
        </li>
    	<li>
        	<form action="MainServlet" id="finduser" name="finduser" method="post">
    			...
    			<input hidden="hidden" class="labelG" type="text" name="searchuser" id="searchuser" value ="">
    		</form>
        </li>
	</ul>
</div>